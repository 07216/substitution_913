...
[y_LDR,opt_LDR, T_LDR(ipar)]=c_compute_pieceLDR1(dist_flag,L_market, U_market, cvk,cvd,L_capacity, U_capacity, L_demand, U_demand, trun_r, trun_rd,x,c,s,h,p);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[ simCostOpt(ipar)  ] = c_simulation_cost(y_LDR, L_market,U_market, dist_flag,cvk,cvd,L_capacity, U_capacity, L_demand, U_demand,x,c,s,h,p,hp,pp,N );

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% compute the true optimal cost
Nk=100;
Nd=100;
[ y_opt, opt_cost(ipar), T_opt(ipar)  ] = c_compute_true_optimal(Nk,Nd,L_market, U_market, dist_flag,cvk,cvd,L_capacity, U_capacity, L_demand, U_demand, x,c,s,h,p );
