function [y_LDR,opt_LDR,T]=c_compute_pieceLDR1(dist_flag, L_market, U_market, cvk,cvd,L_capacity, U_capacity, L_demand, U_demand, trun_r, trun_rd,x,c,s,h,p)
% number of products
N=size(c,2);
...
elseif dist_flag==2
    [E] = simulation_piecewise_mean_normal_correlated( N, L_market, U_market, L_capacity, U_capacity, trun_r, trun_z, L_demand, U_demand, trun_rd, trun_zd, cvk, cvd );
end
